...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "active_leads_count", sa.Integer(), server_default="0", nullable=False
        ),
    ...
    op.create_table(
        ...
        # WARNING: source_type values are derived from SourceType enum in
        # app/schemas/common.py. Do not edit here directly. Add new sources
        # to the Enum, then regenerate migration.
        sa.CheckConstraint(
    ...
    op.create_table(
        ...
        sa.Column(
            "average_deal_size", sa.Numeric(precision=15, scale=2), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["lead_id"], ["leads.lead_id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(
            ["referrer_agent_id"], ["agents.agent_id"], ondelete="SET NULL"
        ),
